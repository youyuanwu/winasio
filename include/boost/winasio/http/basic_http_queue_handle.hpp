#ifndef BOOST_WINASIO_basic_http_queue_handle_HPP
#define BOOST_WINASIO_basic_http_queue_handle_HPP
        ...
        namespace http
        {
            ...
            public:
                ...
                struct rebind_executor
                {
                    ...
                    typedef basic_http_queue_handle<Executor1> other;
                };
                ...
                explicit basic_http_queue_handle(const executor_type & ex)
                    : winnet::basic_overlapped_handle<Executor>(ex)
                {
                }

                template <typename ExecutionContext>
                explicit basic_http_queue_handle(
                ...
                basic_http_queue_handle(basic_http_queue_handle && other)
                    : winnet::basic_overlapped_handle<Executor>(std::move(other))
                {
                }

                basic_http_queue_handle & operator=(basic_http_queue_handle && other)
                {
                ...
                template <BOOST_ASIO_COMPLETION_TOKEN_FOR(void(boost::system::error_code, std::size_t)) ReadHandler
                        ...
                        handler BOOST_ASIO_DEFAULT_COMPLETION_TOKEN(executor_type))
                {
                    ...
                    boost::asio::windows::overlapped_ptr optr(this->get_executor(), std::move(handler));
                    ULONG result =
                    ...
                    else
                    {
                        ...
                        ec = boost::system::error_code(result, boost::asio::error::get_system_category());
                        ...
                        handler BOOST_ASIO_DEFAULT_COMPLETION_TOKEN(executor_type))
                {
                    ...
                    boost::asio::windows::overlapped_ptr optr(this->get_executor(), std::move(handler));
                    DWORD result =
                        HttpReceiveRequestEntityBody(this->native_handle(), RequestId, Flags, EntityBuffer, EntityBufferLength,
                                                     NULL, //    BytesReturned,
                                                     optr.get());
                    boost::system::error_code ec;
                ...
                template <BOOST_ASIO_COMPLETION_TOKEN_FOR(void(boost::system::error_code, std::size_t)) WriteHandler
                              BOOST_ASIO_DEFAULT_COMPLETION_TOKEN_TYPE(executor_type)>
                ...
                void send_response(PHTTP_RESPONSE resp, HTTP_REQUEST_ID requestId, ULONG flags, boost::system::error_code & ec)
                {
...
#endif // BOOST_WINASIO_basic_http_queue_handle_HPP
