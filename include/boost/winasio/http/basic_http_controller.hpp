...
namespace boost
{
    namespace winasio
    {
        namespace http
        {
            ...
            public:
                basic_http_controller(basic_http_queue_handle<Executor> & queue, const std::wstring & url_base)
                    : queue_(queue)
                    , base_url_(format_url_base(url_base))
                {
                ...
                {
                    register_url_part<HTTP_VERB::HttpVerbGET>(url_part, std::forward<Handler>(h));
                }
                ...
                void post(const std::wstring & url_part, Handler && h)
                {
                    ...
                    register_url_part<HTTP_VERB::HttpVerbPOST>(url_part, std::forward<Handler>(h));
                }
                ...
                void put(const std::wstring & url_part, Handler && h)
                {
                    ...
                    register_url_part<HTTP_VERB::HttpVerbPUT>(url_part, std::forward<Handler>(h));
                }
                ...
                void del(const std::wstring & url_part, Handler && h)
                {
                    ...
                    register_url_part<HTTP_VERB::HttpVerbDELETE>(url_part, std::forward<Handler>(h));
                }
            ...
            private:
                std::map<std::wstring, std::array<request_handler, HTTP_VERB::HttpVerbMaximum>>
                    handlers_;
