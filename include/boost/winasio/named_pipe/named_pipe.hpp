...
namespace boost
{
    namespace winasio
    {
        ...
        public:
            ...
            void server_create(boost::system::error_code & ec, endpoint_type const & endpoint)
            {
            ...
            template <BOOST_ASIO_COMPLETION_TOKEN_FOR(void(boost::system::error_code, std::size_t)) ConnectHandler
                          BOOST_ASIO_DEFAULT_COMPLETION_TOKEN_TYPE(executor_type)>
            BOOST_ASIO_INITFN_AUTO_RESULT_TYPE(ConnectHandler, void(boost::system::error_code, std::size_t))
            ...
            BOOST_ASIO_SYNC_OP_VOID connect(const endpoint_type & endpoint, boost::system::error_code & ec, int timeout_ms = 20000)
            {
